\section{Description of Product / Structure: Describe the creative ideation and what is new?}
...
\section{Define functionality– Design, Modeling and Assembly Complexity:}
...
\end{tabular}
\end{center}
\section{Briefly explain what new functionalities (system and sub-system ) you are planning to add. How your product is different from existing products:}
...
\section{Picture of  the Proposed System (or Similar System): (please include a reference if you are using pictures from internet). You can also include conceptual sketch.}
